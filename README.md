...
**wove** aims to provide an open-source toolkit for learning to knit and crochet and for building a robotic knitting machine. Documentation in `docs/` walks through the basics of these crafts while the `cad/` directory contains OpenSCAD files for printable hardware components.
