...
export const fallbackPatternPlannerEvents = patternPlannerEvents;
...
Object.freeze(patternDefaults);
export const fallbackPatternDefaults = patternDefaults;

export const machineProfileFallbackMessage =
  'Machine profile metadata unavailable. Export with --machine-profile to surface axis settings.';
export const machineProfileEnvelopeFallbackMessage =
  'Machine profile envelope unavailable. Include travel_min_mm and travel_max_mm for each axis.';
export const machineProfileEnvelopeMissingAxesPrefix =
  'Machine profile envelope unavailable — add travel_min_mm and travel_max_mm for: ';
export const boundsComparisonFallbackMessage =
  'Bounds comparison unavailable. Export planner bounds and machine profile limits to compare.';
export const homingGuardFallbackMessage =
  'Homing guard metadata unavailable. Export planner defaults.require_home and defaults.home_state.';
export const homingGuardPositionFallbackMessage = 'Coordinates: Awaiting planner coordinates…';
export const heatedBedStatusFallbackMessage =
  'Thermistor conduit reserved for the heater upgrade — planner status drives the glow along the '
  + 'wiring path.';
export const heatedBedMetadataMissingMessage =
  'Heated bed conduit metadata missing — include heated_bed_conduit defaults to drive the glow.';
export const heatedBedRouteFallbackMessage =
  'Conduit status: Illuminating the bay-to-bed run so heater wiring stays obvious during dry runs.';
export const patternBoundsFallbackMessage =
  'Planner bounds unavailable. Export --format planner payloads with bounds to preview the motion '
  + 'envelope.';
export const patternDefaultsFallbackMessage =
  'Planner defaults unavailable. Export planner payloads with defaults metadata to surface feed and '
  + 'height settings.';
...
export const yarnFlowSpoolFallbackMessage = 'Spool status: Parked until planner preview loads.';
export const yarnFlowTotalFallbackMessage = 'Total yarn fed: Awaiting planner preview…';
export const yarnFlowProgressFallbackMessage = 'Spool progress: Awaiting planner preview…';
export const yarnFlowRateFallbackMessage = 'Feed rate: Awaiting yarn feed telemetry…';
export const yarnFlowQueueFallbackMessage = 'Remaining feed pulses: Awaiting planner preview…';
export const yarnFlowUpcomingFallbackMessage = 'Next feed pulses: Awaiting planner preview…';
export const yarnFlowTimingFallbackMessage = 'Feed timing: Awaiting planner preview…';
export const yarnFlowCycleFallbackMessage = 'Cycle pacing: Awaiting planner preview…';
export const yarnFlowCalibrationFallbackMessage =
  'Calibration: Awaiting tension sensor calibration metadata.';
export const yarnFlowTensionFallbackMessage = 'Tension telemetry: Awaiting planner preview…';
export const yarnFlowPositionFallbackMessage = 'Coordinates: Awaiting yarn flow coordinates…';
export const spoolProgressCountdownFallbackMessage = 'Next feeds: Awaiting Yarn Flow timing…';
export const spoolCountdownPausedMessage =
  'Countdown ribbon pinned while the preview is paused — resume to advance timing.';

export const spoolPrePulseSettings = Object.freeze({
  speed: 2.8,
  phaseOffset: Math.PI / 10,
});

export const spoolProgressTonePalette = Object.freeze({
