export const selectionRingHeight = 0.06;
export const selectionSweepSpeed = 0.9;

export const patternPreviewSource = 'assets/base_chain_row.planner.json';
export const defaultPatternPreviewDurationSeconds = 14;

export const fallbackPatternPlannerEvents = Object.freeze([
  ...
  {
    comment: 'chain stitch 1 of 3: feed yarn',
    x: 0.0,
    y: 0.0,
    z: -1.5,
    extrusion: 0.5,
  ...
  {
    comment: 'chain stitch 2 of 3: feed yarn',
    x: 5.0,
    y: 0.0,
    z: -1.5,
    extrusion: 1.0,
  ...
  {
    comment: 'chain stitch 3 of 3: feed yarn',
    x: 10.0,
    y: 0.0,
    z: -1.5,
    extrusion: 1.5,
  ...
  {
    comment: 'single stitch 1 of 1: feed yarn',
    x: 0.0,
    y: 12.0,
    z: -2.0,
    extrusion: 2.1,
...
export const fallbackPatternDefaults = Object.freeze({
  safe_z_mm: 4.0,
...
export const spoolProgressCountdownFallbackMessage =
...
export const homingGuardFallbackMessage =
  ...
  + 'defaults.home_state.';
export const homingGuardPositionFallbackMessage =
...
export const heatedBedRouteFallbackMessage =
  'Conduit status: Illuminating the bay-to-bed run so heater wiring stays obvious during dry '
  + 'runs.';
...
export const patternDefaultsFallbackMessage =
  'Planner defaults unavailable. Export planner payloads with defaults metadata to surface feed '
  + 'and height settings.';
...
export const yarnFlowTensionFallbackMessage =
  'Tension telemetry: Awaiting planner preview…';
export const yarnFlowPositionFallbackMessage =
